...
export default function Sidebar() {
  ...
  // 2. SUPER ADMIN MENU (Matches Screenshot)
  const superAdminMenu = [
    { name: "Dashboard", path: "/admin", icon: "M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6z" }, // Dashboard Icon
    { name: "Loans Details", path: "/admin/loans-details", icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" }, // Stacked Doc
    { name: "Monitoring", path: "/admin/monitoring", icon: "M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" }, // Chart
    { name: "Worker's Pad", path: "/admin/workers-pad", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" }, // Edit
    { name: "Uploads", path: "/admin/uploads", icon: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" }, // Upload
    { name: "PLE Dashboard", path: "/admin/ple", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" }, // Trend
    { name: "Authorization", path: "/admin/authorization", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11.536 19.336A1.5 1.5 0 0110.233 20h-2.466a1.5 1.5 0 01-1.303-.703l-1.303-2.172a1.5 1.5 0 01-.157-1.348l.78-2.6a6 6 0 018.21-6.177z" }, // Key
    { name: "Staff Management", path: "/admin/staff", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" }, // Users
    { name: "Claims Center", path: "/admin/claims", icon: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }, // Alert
    
    // Standard Admin Features included below
    { name: "Clients", path: "/admin/clients", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857" },
    { name: "Investors", path: "/admin/investors", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1" },
    ...
    { name: "Compliance", path: "/admin/compliance", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2" },
    { name: "Support Desk", path: "/admin/support", icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636" },
  ];
        ...
        <div className="flex items-center gap-3 mb-4 px-2">
          ...
          <div className="overflow-hidden">
            <p className="text-sm font-medium text-white truncate">
              {role === 'super_admin' ? 'System Administrator' : role === 'admin' ? 'Loan Officer' : user?.email?.split('@')[0]}
            </p>
