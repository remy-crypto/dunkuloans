...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "KYC Queue", path: "/kyc", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
    { name: "Collateral Review", path: "/collateral", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    { name: "Support Desk", path: "/support", icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
  ];
  ...
  return (
    <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col min-h-screen sticky top-0 overflow-y-auto">
      ...
      <div className="px-6 mb-4">
        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Worker Portal</p>
      </div>
      ...
      <div className="p-4 border-t border-gray-800 mt-auto">
        <div className="flex items-center gap-3 mb-4 px-2">
          ...
          <div className="overflow-hidden">
            <p className="text-sm font-medium text-white truncate">Loan Officer</p>
