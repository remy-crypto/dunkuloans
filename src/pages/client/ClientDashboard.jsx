...
const ClientDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-gray-100">
      {/* Sidebar is handled by Layout in App.jsx usually, but if using direct page import, we include it here or let Layout handle it. 
          Since App.jsx wraps this in <Layout>, we DO NOT need <Sidebar /> here if Layout has it.
          However, based on your App.jsx, <Layout> has the sidebar. 
          So we remove Sidebar from here to avoid double sidebars. */}
      
      {/* <Sidebar />  <-- Removed because Layout handles this */}
