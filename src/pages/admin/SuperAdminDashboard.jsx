...
export default function SuperAdminDashboard() {
  ...
  const fetchData = async () => {
    ...
    if (loans) {
      ...
      // Upcoming Repayments (using balance of active loans)
      ...
      // Agent Metrics (assuming agent_id exists on loans)
      ...
      setStats({
        ...
        projectedYield: totalInv * 0.12, // Mock 12% yield calculation
  ...
  if (loading) return <div className="p-10 text-center text-gray-500 bg-gray-50 h-screen">Loading System Data...</div>;
