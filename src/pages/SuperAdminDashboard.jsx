    ...
    <div className="bg-gray-50 min-h-full p-8 text-gray-900 font-sans">
      ...
      <div className="flex justify-between items-end mb-8">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-1.5 bg-white text-gray-600 text-xs font-medium rounded border border-gray-200 shadow-sm">This Month</button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-2 text-xs">
              <span className="px-2 py-1 bg-gray-100 text-gray-600 rounded font-medium cursor-pointer">Revenue</span>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-2 w-full mt-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <p className="text-gray-500 text-xs mb-8">Performance of filled agent origination.</p>
